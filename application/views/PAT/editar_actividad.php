                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <select class="custom-select" required="" name="eje">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <select class="custom-select" required="" name="polipub">
                                    <option value="">Seleccione...</option>
                                </select>
                                <div class="valid-feedback"> </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <select class="custom-select" required="" name="pobObj">
                                    <option value="">Seleccione...</option>
                                </select>
                                <div class="valid-feedback"> </div>
                            </div>
                        ...
                        <div class="col-md-2 mb-2">
                            <label for="validationCustom04">ODS:</label>
