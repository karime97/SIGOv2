            ...
            <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <img class="img-fluid model_img" id="sa-warning" alt="alert">
                            </div>
                        </div>
                    </div>
            <script>
...
<link href="<?=base_url()?>public/libs/sweetalert2/dist/sweetalert2.min.css" rel="stylesheet">
<script src="<?=base_url()?>public/libs/sweetalert2/dist/sweetalert2.all.min.js"></script>
<script src="<?=base_url()?>public/libs/sweetalert2/sweet-alert.init.js"></script>
